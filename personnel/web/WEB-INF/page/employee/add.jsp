...
<html>
  ...
  <body>
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${emp.emp_id }" >
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline" lay-filter="test1" >
                  <select id="job_id" name="job_id" class="valid" >
                    ...
                    <option value="${line.id}" <c:if test="${job.job == line.id }">selected</c:if>>${line.name}</option>
                    </c:forEach>
                  </select>
              </div>
          </div>
            ...
            <div class="layui-form-item" >
              ...
              <div class="layui-input-inline" lay-filter="test2">
                  <select id="dept_id" name="dept_id" class="valid">
                    ...
                    <option value="${line.id}" <c:if test="${dept.did == line.id }">selected</c:if>>${line.name}</option>
                    </c:forEach>
                  </select>
              </div>
          </div>         
