...
<html>
  ...
  <head>
    ...
    <link rel="shortcut icon" href="/xj.ico" type="image/x-icon" />
  ...
  <body>
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${dept.did}" >
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${dept.dname }">
              </div>
          </div>
          <div class="layui-form-item">
              <%--@declare id="phone"--%><label for="phone" class="layui-form-label">
                  <span class="x-red">*</span>详细信息
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="remark" name="remark" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${dept.dremark }">
              </div>
